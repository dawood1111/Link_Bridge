...
function SideBar() {
  ...
  return (
    <>
      <div className="hidden sm:flex min-h-full sm:flex-col flex-row items-start bg-white text-[#0c2b78] sm:is-drawer-close:w-26 sm:is-drawer-open:w-64 z-[50] sm:fixed shadow-xl   ">
        <ul className="menu w-full grow gap-12 mt-22  ">
          <li className="">
            <button
              className="is-drawer-close:tooltip is-drawer-close:tooltip-right flex item-center justify-center  h-14 rounded-4xl"
              data-tip="Homepage"
          ...
          <li>
            ...
            >
              <Icon name="sign out " className="inline-block " />
