    ...
    public partial class ImagesMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutHelpers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AboutHelpers_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConstructionProjects_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImagePosts_HelpRequests_HelpRequestId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "c4a53839-64d7-4cba-b7db-01521546187e", null, "ConstructionCompany", "CONSTRUCTIONCOMPANY" },
                    { "d86e22f9-5ed8-41b9-954d-3ef63013d496", null, "ITCompany", "ITCOMPANY" },
                    { "dfe67d69-6ca7-48ab-aecb-c7d0bec3b2cb", null, "it", "IT" },
                    { "f25404c3-7e40-4c7b-80b9-c3df5497bc0d", null, "Admin", "ADMIN" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_AboutHelpers_UserId",
                table: "AboutHelpers",
                column: "UserId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImagePosts_HelpRequestId",
                table: "ImagePosts",
